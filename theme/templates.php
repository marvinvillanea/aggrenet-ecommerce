...
<head>
    ...
    <meta name="author" content="">
          <?php 
            ...
            ?>
    <title>Home | <?= $results->company_name ?></title>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 09069853816</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> leo@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/food1.png" alt="" width="80" height="80"/></a>
            </div> 
          </div>
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                <li><a href="<?php echo web_root;?>index.php?q=cart"><i class="fa fa-certificate"></i> MyOrder</a></li>
    ...
    <h5 class = "text-center">
      <!-- 10:22AM -->
      <div style="text-align:center;"><iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=en&size=small&timezone=Asia%2FManila" width="100%" height="90" frameborder="0" seamless></iframe> </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                <li><a href="<?php echo web_root;?>index.php?q=product" class="active">Home</a></li>
                <li class="dropdown"><a href="#">Food Categories<i class="fa fa-angle-down"></i></a>
                 ...
                 <li><a href="<?php web_root?>index.php?q=product">All</a></li>
                <li><a href="<?php web_root?>index.php?q=contact">Contact</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3 mobile-size">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              ...
              <p><?= $results->company_name ?> Online Ordering Service</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
...
<img src="images/home/order.png" alt="" width="300px" height="85px" />
...
<img src="images/home/foods2.png" alt="" width="300px" height="85px" />
    ...
    <div class="footer-widget">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>About <?= $results->company_name ?></h2>
              <ul class="nav nav-pills nav-stacked">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="index.php">Leo</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="index.php"><?= $results->company_name ?>.inc</a></span></p>
        </div>
      </div>
    </div>
 ...
 <?php include "validation_user.php"; ?> 
...
if($singlecustomer->is_validate_email == 0) {
  ?>
  <script>
   $('#validateModal').modal({backdrop: 'static', keyboard: false}, 'show');
  </script>
  <?php
} 
if(isset($_GET["verify"])) {
  ?>
    <script>
      $('.verification_text').html('<center> <center><h3>Account <span class="text-danger">FULLY VERIFIED</span>.</h3> <h4>Thank you</h4> </center></center>');
    $('.verification_text').html('<center> <center> <h3>Account <span class="text-danger">FULLY VERIFIED</span>.</h3> <h4>Thank you</h4> </center></center>');
    $('.verification_BUTTON').html('<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>');
